 ...
 * @author capdevon
 */
public class MyChaseCamera implements ActionListener, AnalogListener, Control, JmeCloneable {
     ...
     */
    public MyChaseCamera(Camera cam, Spatial target) {
        this(cam);
     ...
     * @param inputManager the inputManager of the application to register inputs
     */
    public MyChaseCamera(Camera cam, Spatial target, InputManager inputManager) {
        this(cam, target);
        registerWithInput(inputManager);
    }
